...
🎓 Acadêmico de Sistemas de Informação na Unipar.

🎂 Tenho 22 anos.

🐧 Especialista em Linux, operando servidor próprio em Debian para hospedagem e deploy de aplicações.

💻 Experiência sólida em desenvolvimento Frontend (React) e Backend (PHP, Node.js).

📱 Desenvolvedor Mobile (Dart/Flutter) com foco em aplicativos funcionais e integração de sistemas.
